...
export function EUFlagIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <rect width="810" height="540" fill="#0055A4" />
      <g transform="translate(405, 270)">
        {Array.from({ length: 12 }).map((_, i) => {
          ...
          return (
            <path
              key={i}
              d="M0,-90 L0,-35 L-20,-25 L0,-15 L0,0 L20,-10 L40,0 L20,-25 L40,-35 L15,-45 Z"
              fill="#FFCC00"
              transform={`translate(${x}, ${y}) rotate(${(i * 30) + 90})`}
            />
          )
        })}
      </g>
...
export function CredentialIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
